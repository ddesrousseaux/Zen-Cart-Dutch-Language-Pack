...
define('MODULE_SHIPPING_FLATMULTIPLE_TEXT_TITLE', 'Meerdere vaste tarieven');
define('MODULE_SHIPPING_FLATMULTIPLE_TEXT_DESCRIPTION', 'Meerdere vaste tarieven');
define('MODULE_SHIPPING_FLAT_TEXT_WAY', 'Standaard verzending');
