...
define('TEXT_DELETE_WARNING_CHILDS', '<b>Waarschuwing:</b> er zijn nog steeds %s subcategorieën gekoppeld aan deze categorie!');
define('TEXT_DELETE_WARNING_PRODUCTS', '<b>Waarschuwing: </b> er zijn nog steeds %s artikelen gekoppeld aan deze categorie!');
...
define('TEXT_PRODUCTS_WEIGHT', 'Artikelgewicht (kg):');
