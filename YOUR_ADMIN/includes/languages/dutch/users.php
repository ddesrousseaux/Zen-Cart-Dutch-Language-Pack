...
define('ERROR_ADMIN_NAME_TOO_SHORT', 'Een Admin gebruikersnaam moet minimaal %s tekens bevatten');
define('ERROR_PASSWORD_TOO_SHORT', 'Een wachtwoord moet minimaal %s tekens bevatten');
define('SUCCESS_NEW_USER_ADDED', 'Nieuwe gebruiker toegevoegd');
define('SUCCESS_USER_DETAILS_UPDATED', 'Gebruikerdetails gewijzigd');
define('SUCCESS_PASSWORD_UPDATED', 'Wachtwoord gewijzigd');
define('ERROR_ADMIN_INVALID_EMAIL_ADDRESS', 'Sorry, het e-mailadres dat u hebt opgegeven bevat ongeldige tekens.');
define('ERROR_ADMIN_INVALID_CHARS_IN_USERNAME', 'Sorry, de Admingebruikersnaam dat u heeft opgegeven bevat ongeldige tekens.');
